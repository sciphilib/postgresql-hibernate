...
public class UpdateAppointmentViewController {
	...
	public Appointment getNewlyUpdatedAppointment() {
		return newAppointment;
	}

	public void setAppointment(Appointment appointment) {
		newAppointment = appointment;
		Doctor doctor = doctorDao.findById(appointment.getIdDoctor());
		doctorComboBox.setValue(doctor);
		Weekday weekday = weekdayDao.findById(appointment.getIdWeekday());
		weekdayComboBox.setValue(weekday);
		beginTimeField.setText(appointment.getBeginDate().toString());
		endTimeField.setText(appointment.getEndDate().toString());
		officeField.setText(appointment.getOffice().toString());
		districtField.setText(appointment.getDistrict().toString());
	}
    ...
    private void handleUpdateAppointment() {
		try {
			...
			Integer id = newAppointment.getId();
			
			newAppointment = new Appointment(id, doctor.getId(), weekday.getId(),
