...
public class AddPrescribedMedicationViewController {

	public PrescribedMedication getNewlyAddedPrescribedMedication() {
    ...
    @FXML
    private void handleAddPrescribedMedication() {
		Visit visit = visitComboBox.getValue();
		Medication medication = medicationComboBox.getValue();
		newPrescribedMedication = new PrescribedMedication(1, visit.getId(), medication.getId());
